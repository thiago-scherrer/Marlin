...
// @section lcd
  ...
  #define SHORT_MANUAL_Z_MOVE 0.0051 // (mm) Smallest manual Z move (< 0.1mm)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      108  // (mm) The length of filament for a complete unload.
